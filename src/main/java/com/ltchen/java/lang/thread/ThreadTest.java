...
public class ThreadTest {
    ...
    public static void main(String[] args) {
        ...
        DrawMoneyRunnable drawMoneyRunnable0 = new DrawMoneyRunnable(account, 700);
        DrawMoneyRunnable drawMoneyRunnable1 = new DrawMoneyRunnable(account, 700);
        Thread myThread0 = new Thread(drawMoneyRunnable0);
